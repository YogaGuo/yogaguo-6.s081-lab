...
int main(int argc, char *argv[])
{
  ...
  20:	54010413          	addi	s0,sp,1344
    ...
    if (argc < 2)
  24:	4785                	li	a5,1
  26:	02a7d363          	bge	a5,a0,4c <main+0x4c>
    {
    ...
    if (argc + 1 > MAXARG)
  2a:	47fd                	li	a5,31
  2c:	02a7df63          	bge	a5,a0,6a <main+0x6a>
    {
        fprintf(2, "too much argvs\n");
  30:	00001597          	auipc	a1,0x1
  34:	8c858593          	addi	a1,a1,-1848 # 8f8 <malloc+0x100>
  38:	4509                	li	a0,2
  3a:	00000097          	auipc	ra,0x0
  3e:	6d2080e7          	jalr	1746(ra) # 70c <fprintf>
        exit(1);
  42:	4505                	li	a0,1
  44:	00000097          	auipc	ra,0x0
  48:	37e080e7          	jalr	894(ra) # 3c2 <exit>
        fprintf(2, "Usage: %s <param>\n", argv[0]);
  4c:	6190                	ld	a2,0(a1)
  4e:	00001597          	auipc	a1,0x1
  52:	89258593          	addi	a1,a1,-1902 # 8e0 <malloc+0xe8>
  56:	4509                	li	a0,2
  58:	00000097          	auipc	ra,0x0
  5c:	6b4080e7          	jalr	1716(ra) # 70c <fprintf>
        exit(1);
  60:	4505                	li	a0,1
  62:	00000097          	auipc	ra,0x0
  66:	360080e7          	jalr	864(ra) # 3c2 <exit>
  6a:	05a1                	addi	a1,a1,8
  6c:	ec040793          	addi	a5,s0,-320
  70:	ffe5069b          	addiw	a3,a0,-2
  74:	1682                	slli	a3,a3,0x20
  76:	9281                	srli	a3,a3,0x20
  78:	068e                	slli	a3,a3,0x3
  7a:	ec840713          	addi	a4,s0,-312
  7e:	96ba                	add	a3,a3,a4
    }
  ...
  82:	e398                	sd	a4,0(a5)
    for (int i = 1; i < argc; i++)
  84:	05a1                	addi	a1,a1,8
  86:	07a1                	addi	a5,a5,8
  88:	fed79ce3          	bne	a5,a3,80 <main+0x80>

    full_argv[argc] = 0;
  8c:	00351793          	slli	a5,a0,0x3
  90:	fc040713          	addi	a4,s0,-64
  94:	97ba                	add	a5,a5,a4
  96:	f007b023          	sd	zero,-256(a5)
    int len;
    int i;
    while (1)
    {
  ...
  9e:	fff5099b          	addiw	s3,a0,-1
  a2:	098e                	slli	s3,s3,0x3
  a4:	99ba                	add	s3,s3,a4
        i = 0;
  a6:	ac040493          	addi	s1,s0,-1344
  aa:	8952                	mv	s2,s4
            len = read(0, &input_argv[i], 1);
  ac:	4605                	li	a2,1
  ae:	85a6                	mv	a1,s1
  ...
  b6:	328080e7          	jalr	808(ra) # 3da <read>
            if (len == 0 || input_argv[i] == '\n')
  ba:	c901                	beqz	a0,ca <main+0xca>
  bc:	0485                	addi	s1,s1,1
  be:	fff4c783          	lbu	a5,-1(s1)
  c2:	01578463          	beq	a5,s5,ca <main+0xca>
            i++;
  c6:	2905                	addiw	s2,s2,1
            len = read(0, &input_argv[i], 1);
  c8:	b7d5                	j	ac <main+0xac>
        if (i == 0)
  ca:	06090c63          	beqz	s2,142 <main+0x142>
        input_argv[i] = 0;
  ce:	fc040793          	addi	a5,s0,-64
  d2:	993e                	add	s2,s2,a5
  d4:	b0090023          	sb	zero,-1280(s2)
        full_argv[argc - 1] = input_argv;
  d8:	ac040793          	addi	a5,s0,-1344
  dc:	f0f9b023          	sd	a5,-256(s3)
        int pid = fork();
  e0:	00000097          	auipc	ra,0x0
  e4:	2da080e7          	jalr	730(ra) # 3ba <fork>
        if (pid < 0)
  e8:	02054963          	bltz	a0,11a <main+0x11a>
        {
            fprintf(2, "fork() error!\n");
            exit(1);
        }
        else if (pid == 0)
  ec:	e529                	bnez	a0,136 <main+0x136>
        {
            exec(full_argv[0], full_argv);
  ee:	ec040593          	addi	a1,s0,-320
  f2:	ec043503          	ld	a0,-320(s0)
  f6:	00000097          	auipc	ra,0x0
  fa:	304080e7          	jalr	772(ra) # 3fa <exec>
            fprintf(2, "exec() error!\n");
  fe:	00001597          	auipc	a1,0x1
 102:	81a58593          	addi	a1,a1,-2022 # 918 <malloc+0x120>
 106:	4509                	li	a0,2
 ...
 116:	2b0080e7          	jalr	688(ra) # 3c2 <exit>
            fprintf(2, "fork() error!\n");
 11a:	00000597          	auipc	a1,0x0
 11e:	7ee58593          	addi	a1,a1,2030 # 908 <malloc+0x110>
 122:	4509                	li	a0,2
 124:	00000097          	auipc	ra,0x0
 128:	5e8080e7          	jalr	1512(ra) # 70c <fprintf>
            exit(1);
 12c:	4505                	li	a0,1
 12e:	00000097          	auipc	ra,0x0
 132:	294080e7          	jalr	660(ra) # 3c2 <exit>
        }
        else
        {
            wait((int *)0);
 ...
 13c:	292080e7          	jalr	658(ra) # 3ca <wait>
    {
 140:	b79d                	j	a6 <main+0xa6>
        }
    }
    exit(0);
 142:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4aa:	48a50513          	addi	a0,a0,1162 # 930 <digits>
 4ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 576:	3beb8b93          	addi	s7,s7,958 # 930 <digits>
 ...
 6b6:	27690913          	addi	s2,s2,630 # 928 <malloc+0x130>
        while(*s != 0){
...
free(void *ap)
{
 ...
 77e:	1ce7b783          	ld	a5,462(a5) # 948 <freep>
 ...
 7ac:	00e6ea63          	bltu	a3,a4,7c0 <free+0x50>
{
 ...
 7ee:	14f73f23          	sd	a5,350(a4) # 948 <freep>
}
 7f2:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 820:	12c53503          	ld	a0,300(a0) # 948 <freep>
 ...
 848:	10490913          	addi	s2,s2,260 # 948 <freep>
  if(p == (char*)-1)
 84c:	5afd                	li	s5,-1
 84e:	a88d                	j	8c0 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 850:	00000797          	auipc	a5,0x0
 854:	10078793          	addi	a5,a5,256 # 950 <base>
 858:	00000717          	auipc	a4,0x0
 85c:	0ef73823          	sd	a5,240(a4) # 948 <freep>
 860:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 882:	0ca73523          	sd	a0,202(a4) # 948 <freep>
      return (void*)(p + 1);
